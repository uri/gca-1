...
namespace WindowsPhoneGame2
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if(gameTime.TotalGameTime.TotalMilliseconds - timeOfGameStart > 30000){
                ended = true;
            }
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            {
            spriteBatch.DrawString(font, "" +(30 -( (gameTime.TotalGameTime.TotalMilliseconds - timeOfGameStart) / 1000.0f)), otherFontPos, Color.Green);
            }else{
                if (((gameTime.TotalGameTime.TotalMilliseconds - timeOfGameStart) / 1000.0f) % 2 == 0)
                {
                  spriteBatch.DrawString(font, "" +(30 -( (gameTime.TotalGameTime.TotalMilliseconds - timeOfGameStart) / 1000.0f)), otherFontPos, Color.Red);
                }else{
                                      spriteBatch.DrawString(font, "" +(30 -( (gameTime.TotalGameTime.TotalMilliseconds - timeOfGameStart) / 1000.0f)), otherFontPos, Color.Yellow);
                }
            }
